...
<div class="uk-padding-small uk-padding-remove-horizontal ">
    ...
    <div class="uk-child-width-1-1@s uk-child-width-1-3@m uk-child-width-1-3@l uk-text-center uk-grid-small" uk-grid>
            ...
            <div>
                ...
                <div class="uk-padding uk-padding-remove-horizontal" uk-grid>
                    <div class="uk-width-2-5 uk-flex">
                        <img src="{{asset($t->image)}}" class="uk-border-circle dynamical-small-img " alt="" uk-img>
                    </div>
                    <div class="uk-width-expand">
                        <h4>{{$t->name}}</h4>
                        <div class="text-small">
